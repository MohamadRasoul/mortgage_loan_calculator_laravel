        ...
        <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 justify-center w-full ">
            <li class="mr-2">
                <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-white shadow"
                   x-bind:class="{ 'bg-gray-50 text-gray-800 ': activeTab === 'origPayment' }"
                   x-on:click="activeTab = 'origPayment'">
                    Orig Payment
                </a>
            </li>
            @if($loan->monthly_fixed_extra_payment > 0 )
                <li class="mr-2">
                    <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-white shadow "
                       x-bind:class="{ 'bg-gray-50 text-gray-800 ': activeTab === 'extraPayment' }"
                       x-on:click="activeTab = 'extraPayment'">
                        Extra Payment
                    </a>
                </li>
            @endif
