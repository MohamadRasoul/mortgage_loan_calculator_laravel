        ...
        <div class="space-y-12">
            <div class="pb-12 border-b border-gray-900/10">
                <h2 class="text-base font-semibold leading-7 text-gray-900">
                    Mortgage Payments Calculator With Extra Payment
                </h2>
                ...
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="pb-12 col-span-full ">
                        <label for="monthly_fixed_extra_payment"
                        ...
                        <div class="mt-2">
                            <input type="number" name="monthly_fixed_extra_payment" id="monthly_fixed_extra_payment"
                                   ...
                                   class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                   value="{{ old('monthly_fixed_extra_payment') }}"
                            >
                            <x-input-error :messages="$errors->get('monthly_fixed_extra_payment')" class="mt-2"/>
