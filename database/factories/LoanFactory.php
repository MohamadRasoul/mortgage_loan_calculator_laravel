...
class LoanFactory extends Factory
{
    ...
    {
        return [
            'loan_amount' => $this->faker->numberBetween( 100_000, 1000_000),
            'loan_term' => $this->faker->numberBetween(1,50),
            'interest_rate' => $this->faker->randomFloat(min:  3,max: 6),
            'monthly_fixed_extra_payment' => $this->faker->numberBetween(100, 10000),
